...
const URL = "http://localhost:1337/gpu-specs/";
...
function GpuSpecs({ id }) {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setAllmant(request.data.gpu_specs_props_allmants);
      setMinne(request.data.gpu_specs_props_minnes);
    }
